  ...
  components: {
    MuiButton: {
      ...
      styleOverrides: {
        ...
        // The one control that writes data carries the drawn drop shadow as well.
        containedSecondary: { boxShadow: `3px 4px 0 ${tokens.ink}`, '&:active': { boxShadow: 'none', transform: 'translate(2px, 3px)' } },
